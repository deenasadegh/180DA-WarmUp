...
pygame.display.set_caption('Rock, Paper, Scissors - Client 1')
...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("rps/client1/result")
        ...
        if event.type == pygame.QUIT:
            ...
            if event.key == pygame.K_ESCAPE:
                ...
                if event.key == pygame.K_r:
                    ...
                    client.publish("rps/client1/choice", "rock")
                elif event.key == pygame.K_p:
                    user_choice_img = paper_img
                    client.publish("rps/client1/choice", "paper")
                elif event.key == pygame.K_s:
                    user_choice_img = scissors_img
                    client.publish("rps/client1/choice", "scissors")
                if user_choice_img:
